...
public class LoadPackageHook implements IXposedHookLoadPackage {
	...
	public void handleLoadPackage(LoadPackageParam lpparam) throws Throwable {
		if (lpparam.packageName.equals("com.miui.home")) {
			...
			try {
				Class.forName("com.miui.home.launcher.ShortcutIcon", false,
						classLoader);
				log("Searching for methods...");
				XposedHelpers.findAndHookMethod(
						"com.miui.home.launcher.ShortcutIcon", classLoader,
						"onFinishInflate", new XC_MethodHook() {
							@Override
							protected void afterHookedMethod(
									MethodHookParam param) throws Throwable {
								FrameLayout v = (FrameLayout) param.thisObject;
								Method lp = v.getClass().getMethod(
										"getLayoutParams");
								if (lp == null)
									return;
								if (lp.invoke(v)
									...
									int resID = context.getResources()
											.getIdentifier("icon_title", "id",
													"com.miui.home");
									v.findViewById(resID).setVisibility(
											View.INVISIBLE);
								}
							}
						});
